...
xprintx(7*8,15*8,"Part III: Lookin' for Loki",PAGE1,32);
...
//}
xprint(13*8,15*8,"God Of Thunder",PAGE1,14);
xprint(7*8,17*8,"Part III: Lookin for Loki",PAGE1,32);
fade_in();
*/
timer_cnt=0;
...
thor_info.inventory=1+2+4+8;  //511;
...
if(res_read("STORY3",(char far*)tmp_buff)<0) return;
